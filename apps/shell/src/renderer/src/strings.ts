...
export const strings = {
  zh: {
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 ZenMux 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    noContent: '（无内容）',
    // Account
    accountZenMux: 'ZenMux 账号',
    account: '账号',
    login: '登录',
    loginZenMux: '登录 ZenMux 账号',
    loggedIn: '已登录',
    loggedInZenMux: '已登录 ZenMux',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 ZenMux,请检查网络或代理设置',
    ...
    onbTitle1: '欢迎使用 ZenOffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'ZenOffice 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ ZenMux 积分**',
  ...
  en: {
    ...
    cloudLoginHint: 'Sign in to your ZenMux account to see projects you created on the web.',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountZenMux: 'ZenMux Account',
    account: 'Account',
    login: 'Sign in',
    loginZenMux: 'Sign in with ZenMux',
    loggedIn: 'Signed in',
    loggedInZenMux: 'Signed in to ZenMux',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach ZenMux — check your network or proxy settings',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to ZenOffice',
    ...
    onbBody2:
      'ZenOffice is still in alpha. Join the group chat on GenTeam to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ ZenMux credits**',
    ...
    onbNote3: 'AI features may consume ZenMux credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'ZenMux アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountZenMux: 'ZenMux アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginZenMux: 'ZenMux アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInZenMux: 'ZenMux にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError: 'ZenMux に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'ZenOffice へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'ZenOffice はまだアルファ版です。GenTeam のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ ZenMux クレジット**',
    ...
    onbNote3: 'AI 機能は ZenMux クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'ZenMux 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    noContent: '(내용 없음)',
    // Account
    accountZenMux: 'ZenMux 계정',
    account: '계정',
    login: '로그인',
    loginZenMux: 'ZenMux 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInZenMux: 'ZenMux에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'ZenMux에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'ZenOffice에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'ZenOffice는 아직 알파 단계입니다. GenTeam 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ ZenMux 크레딧**',
    ...
    onbNote3: 'AI 기능은 ZenMux 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    cloudLoginHint: 'Connectez-vous à votre compte ZenMux pour voir les projets créés sur le web.',
    ...
    noContent: '(vide)',
    // Account
    accountZenMux: 'Compte ZenMux',
    account: 'Compte',
    login: 'Se connecter',
    loginZenMux: 'Se connecter avec ZenMux',
    loggedIn: 'Connecté',
    loggedInZenMux: 'Connecté à ZenMux',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre ZenMux — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans ZenOffice',
    ...
    onbBody2:
      'ZenOffice est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits ZenMux**',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits ZenMux.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem ZenMux-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    noContent: '(leer)',
    // Account
    accountZenMux: 'ZenMux-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginZenMux: 'Mit ZenMux anmelden',
    loggedIn: 'Angemeldet',
    loggedInZenMux: 'Bei ZenMux angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'ZenMux ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei ZenOffice',
    ...
    onbBody2:
      'ZenOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ ZenMux-Guthaben**',
    ...
    onbNote3: 'KI-Funktionen können ZenMux-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de ZenMux para ver los proyectos creados en la web.',
    ...
    noContent: '(vacío)',
    // Account
    accountZenMux: 'Cuenta de ZenMux',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginZenMux: 'Iniciar sesión con ZenMux',
    loggedIn: 'Sesión iniciada',
    loggedInZenMux: 'Sesión iniciada en ZenMux',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con ZenMux — compruebe su red o la configuración del proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a ZenOffice',
    ...
    onbBody2:
      'ZenOffice aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de ZenMux**',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de ZenMux.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี ZenMux เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    // Account
    accountZenMux: 'บัญชี ZenMux',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginZenMux: 'ลงชื่อเข้าใช้ด้วย ZenMux',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInZenMux: 'ลงชื่อเข้าใช้ ZenMux แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ ZenMux ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ ZenOffice',
    ...
    onbBody2:
      'ZenOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต ZenMux กว่า 1,000**',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต ZenMux',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    cloudLoginHint: 'Masuk ke akun ZenMux untuk melihat proyek yang Anda buat di web.',
    ...
    noContent: '(kosong)',
    // Account
    accountZenMux: 'Akun ZenMux',
    account: 'Akun',
    login: 'Masuk',
    loginZenMux: 'Masuk dengan ZenMux',
    loggedIn: 'Sudah masuk',
    loggedInZenMux: 'Sudah masuk ke ZenMux',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke ZenMux — periksa jaringan atau pengaturan proxy Anda',
    ...
    setSecGeneral: 'Umum',
    setSecAbout: 'Tentang',
    setSecWechat: 'Buku harian WeChat',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di ZenOffice',
    ...
    onbBody2:
      'ZenOffice masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit ZenMux**',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit ZenMux.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    cloudLoginHint: 'Войдите в аккаунт ZenMux, чтобы увидеть проекты, созданные в вебе.',
    ...
    noContent: '(пусто)',
    // Account
    accountZenMux: 'Учётная запись ZenMux',
    account: 'Учётная запись',
    login: 'Войти',
    loginZenMux: 'Войти через ZenMux',
    loggedIn: 'Вход выполнен',
    loggedInZenMux: 'Выполнен вход в ZenMux',
    ...
    loginNetworkError: 'Не удаётся подключиться к ZenMux — проверьте сеть или настройки прокси',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в ZenOffice',
    ...
    onbBody2:
      'ZenOffice пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов ZenMux**',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты ZenMux.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب ZenMux لعرض المشاريع التي أنشأتها على الويب.',
    ...
    noContent: '(فارغ)',
    // Account
    accountZenMux: 'حساب ZenMux',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginZenMux: 'تسجيل الدخول باستخدام ZenMux',
    loggedIn: 'تم تسجيل الدخول',
    loggedInZenMux: 'تم تسجيل الدخول إلى ZenMux',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ ZenMux — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في ZenOffice',
    ...
    onbBody2:
      'لا يزال ZenOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة ZenMux**',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة ZenMux.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    cloudLoginHint: 'Entre na sua conta ZenMux para ver os projetos criados na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountZenMux: 'Conta ZenMux',
    account: 'Conta',
    login: 'Entrar',
    loginZenMux: 'Entrar com a ZenMux',
    loggedIn: 'Conectado',
    loggedInZenMux: 'Conectado à ZenMux',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao ZenMux — verifique sua rede ou as configurações de proxy',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao ZenOffice',
    ...
    onbBody2:
      'O ZenOffice ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos ZenMux**',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos ZenMux.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    cloudLoginHint: 'Accedi al tuo account ZenMux per vedere i progetti creati sul web.',
    ...
    noContent: '(vuoto)',
    accountZenMux: 'Account ZenMux',
    account: 'Account',
    login: 'Accedi',
    loginZenMux: 'Accedi con ZenMux',
    loggedIn: 'Accesso effettuato',
    loggedInZenMux: 'Accesso effettuato a ZenMux',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere ZenMux — controlla la rete o le impostazioni del proxy',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in ZenOffice',
    ...
    onbBody2:
      'ZenOffice è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti ZenMux**',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti ZenMux.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    cloudLoginHint: 'Zaloguj się na konto ZenMux, aby zobaczyć projekty utworzone w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountZenMux: 'Konto ZenMux',
    account: 'Konto',
    login: 'Zaloguj się',
    loginZenMux: 'Zaloguj się przez ZenMux',
    loggedIn: 'Zalogowano',
    loggedInZenMux: 'Zalogowano do ZenMux',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z ZenMux — sprawdź sieć lub ustawienia proxy',
    ...
    onbBody2:
      'ZenOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów ZenMux**',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty ZenMux.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    cloudLoginHint:
      'Log in op je ZenMux-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginZenMux: 'Inloggen met ZenMux',
    loggedIn: 'Ingelogd',
    loggedInZenMux: 'Ingelogd bij ZenMux',
    ...
    loginNetworkError: 'Kan ZenMux niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij ZenOffice',
    ...
    onbBody2:
      'ZenOffice is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ ZenMux-credits**',
    ...
    onbNote3: 'AI-functies kunnen ZenMux-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    cloudLoginHint: 'Log masuk ke akaun ZenMux untuk melihat projek yang anda cipta di web.',
    ...
    noContent: '(kosong)',
    accountZenMux: 'Akaun ZenMux',
    account: 'Akaun',
    login: 'Log masuk',
    loginZenMux: 'Log masuk dengan ZenMux',
    loggedIn: 'Telah log masuk',
    loggedInZenMux: 'Telah log masuk ke ZenMux',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke ZenMux — semak rangkaian atau tetapan proksi anda',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke ZenOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'ZenOffice masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit ZenMux**',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit ZenMux.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון ZenMux כדי לראות פרויקטים שיצרתם באתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountZenMux: 'חשבון ZenMux',
    account: 'חשבון',
    login: 'התחברות',
    loginZenMux: 'התחברות עם ZenMux',
    loggedIn: 'מחובר',
    loggedInZenMux: 'מחובר ל-ZenMux',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-ZenMux — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-ZenOffice',
    ...
    onbBody2:
      'ZenOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות ZenMux**',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של ZenMux.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने ZenMux खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountZenMux: 'ZenMux खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginZenMux: 'ZenMux से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInZenMux: 'ZenMux में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'ZenMux से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'ZenOffice में आपका स्वागत है',
    ...
    onbBody2:
      'ZenOffice अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ ZenMux क्रेडिट**',
    ...
    onbNote3: 'AI सुविधाएँ ZenMux क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 ZenMux 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountZenMux: 'ZenMux 帳號',
    account: '帳號',
    login: '登入',
    loginZenMux: '登入 ZenMux 帳號',
    loggedIn: '已登入',
    loggedInZenMux: '已登入 ZenMux',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 ZenMux，請檢查網路或代理設定',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 ZenOffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'ZenOffice 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ ZenMux 點數**',
    onbJoinGenTeam: '加入 GenTeam',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
