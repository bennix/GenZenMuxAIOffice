...
// ZenMux credit-usage page opened from the account menu's credits row.
// Kept main-side so the renderer never supplies the URL.
const CREDIT_USAGE_URL = 'https://zenmux.ai/models'
...
const tMain = createI18n({
  zh: {
    ...
    pdfDocxLoginMsg: '导出为 Word 需要登录 ZenMux 账号。',
    pdfDocxLoginDetail: '点击“登录”将打开浏览器完成授权，完成后请重新点击导出。',
    pdfDocxBtnLogin: '登录',
    pdfDocxConfirmMsg: '将此 PDF 上传到 ZenMux 云端转换为 Word？',
    ...
    pdfDocxNoCliMsg: '无法登录 ZenMux：缺少必需组件（gsk），请重新安装应用。',
  ...
  en: {
    ...
    pdfDocxLoginMsg: 'Exporting as Word requires signing in to ZenMux.',
    pdfDocxLoginDetail:
      'Clicking “Sign In” opens your browser to authorize; once done, click Export again.',
    pdfDocxBtnLogin: 'Sign In',
    pdfDocxConfirmMsg: 'Upload this PDF to ZenMux cloud and convert it to Word?',
    ...
    pdfDocxNoCliMsg:
      'Cannot sign in to ZenMux: a required component (gsk) is missing. Please reinstall the app.',
  ...
  ja: {
    ...
    pdfDocxLoginMsg: 'Word への書き出しには ZenMux へのログインが必要です。',
    pdfDocxLoginDetail:
      '「ログイン」をクリックするとブラウザで認証します。完了後、もう一度書き出しを実行してください。',
    pdfDocxBtnLogin: 'ログイン',
    pdfDocxConfirmMsg: 'この PDF を ZenMux クラウドにアップロードして Word に変換しますか？',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'ZenMux にサインインできません：必要なコンポーネント（gsk）が見つかりません。アプリを再インストールしてください。',
  ...
  ko: {
    ...
    pdfDocxLoginMsg: 'Word로 내보내려면 ZenMux 로그인이 필요합니다.',
    pdfDocxLoginDetail:
      '“로그인”을 클릭하면 브라우저에서 인증합니다. 완료 후 내보내기를 다시 클릭하세요.',
    pdfDocxBtnLogin: '로그인',
    pdfDocxConfirmMsg: '이 PDF를 ZenMux 클라우드에 업로드하여 Word로 변환할까요?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'ZenMux에 로그인할 수 없습니다. 필수 구성 요소(gsk)가 없습니다. 앱을 다시 설치해 주세요.',
  ...
  fr: {
    ...
    pdfDocxLoginMsg: "L'export en Word nécessite une connexion à ZenMux.",
    pdfDocxLoginDetail:
      "Cliquez sur « Se connecter » pour autoriser dans le navigateur, puis relancez l'export.",
    pdfDocxBtnLogin: 'Se connecter',
    pdfDocxConfirmMsg: 'Téléverser ce PDF vers le cloud ZenMux pour le convertir en Word ?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      "Connexion à ZenMux impossible : un composant requis (gsk) est manquant. Veuillez réinstaller l'application.",
  ...
  de: {
    ...
    pdfDocxLoginMsg: 'Für den Word-Export ist eine Anmeldung bei ZenMux erforderlich.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: 'Dieses PDF in die ZenMux-Cloud hochladen und in Word konvertieren?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Anmeldung bei ZenMux nicht möglich: Eine erforderliche Komponente (gsk) fehlt. Bitte installieren Sie die App neu.',
  ...
  es: {
    ...
    pdfDocxLoginMsg: 'Para exportar como Word es necesario iniciar sesión en ZenMux.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: '¿Subir este PDF a la nube de ZenMux para convertirlo a Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'No se puede iniciar sesión en ZenMux: falta un componente necesario (gsk). Reinstale la aplicación.',
  ...
  th: {
    ...
    pdfDocxLoginMsg: 'การส่งออกเป็น Word ต้องเข้าสู่ระบบ ZenMux',
    pdfDocxLoginDetail:
      'คลิก “เข้าสู่ระบบ” เพื่อเปิดเบราว์เซอร์ยืนยันตัวตน เสร็จแล้วให้คลิกส่งออกอีกครั้ง',
    pdfDocxBtnLogin: 'เข้าสู่ระบบ',
    pdfDocxConfirmMsg: 'อัปโหลด PDF นี้ไปยังคลาวด์ ZenMux เพื่อแปลงเป็น Word หรือไม่?',
    ...
    pdfDocxNoCliMsg:
      'ไม่สามารถลงชื่อเข้าใช้ ZenMux ได้: ไม่พบคอมโพเนนต์ที่จำเป็น (gsk) โปรดติดตั้งแอปใหม่',
  ...
  id: {
    ...
    pdfDocxLoginMsg: 'Ekspor sebagai Word memerlukan login ke ZenMux.',
    pdfDocxLoginDetail:
      'Klik “Masuk” untuk membuka browser dan memberi otorisasi; setelah selesai, klik Ekspor lagi.',
    pdfDocxBtnLogin: 'Masuk',
    pdfDocxConfirmMsg: 'Unggah PDF ini ke cloud ZenMux untuk dikonversi ke Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Tidak dapat masuk ke ZenMux: komponen yang diperlukan (gsk) tidak ditemukan. Silakan instal ulang aplikasi.',
  ...
  ru: {
    ...
    pdfDocxLoginMsg: 'Для экспорта в Word требуется вход в ZenMux.',
    pdfDocxLoginDetail:
      'Нажмите «Войти», чтобы авторизоваться в браузере, затем снова запустите экспорт.',
    pdfDocxBtnLogin: 'Войти',
    pdfDocxConfirmMsg: 'Загрузить этот PDF в облако ZenMux и конвертировать в Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Не удаётся войти в ZenMux: отсутствует необходимый компонент (gsk). Переустановите приложение.',
  ...
  ar: {
    ...
    pdfDocxLoginMsg: 'يتطلب التصدير كملف Word تسجيل الدخول إلى ZenMux.',
    pdfDocxLoginDetail:
      'انقر على «تسجيل الدخول» لفتح المتصفح وإتمام التفويض، ثم انقر على التصدير مرة أخرى.',
    pdfDocxBtnLogin: 'تسجيل الدخول',
    pdfDocxConfirmMsg: 'رفع هذا الـ PDF إلى سحابة ZenMux وتحويله إلى Word؟',
    ...
    pdfDocxNoCliMsg:
      'تعذّر تسجيل الدخول إلى ZenMux: المكوّن المطلوب (gsk) مفقود. يُرجى إعادة تثبيت التطبيق.',
  ...
  pt: {
    ...
    menuExportDocx: 'Exportar como Word…',
    pdfDocxLoginMsg: 'Exportar como Word requer login no ZenMux.',
    pdfDocxLoginDetail:
      'Clique em “Entrar” para autorizar no navegador; depois, clique em Exportar novamente.',
    pdfDocxBtnLogin: 'Entrar',
    pdfDocxConfirmMsg: 'Enviar este PDF para a nuvem do ZenMux e convertê-lo em Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Não é possível iniciar sessão no ZenMux: falta um componente necessário (gsk). Reinstale o aplicativo.',
  ...
  it: {
    ...
    pdfDocxLoginMsg: 'Per esportare come Word è necessario accedere a ZenMux.',
    pdfDocxLoginDetail:
      'Fai clic su “Accedi” per autorizzare nel browser; al termine, fai di nuovo clic su Esporta.',
    pdfDocxBtnLogin: 'Accedi',
    pdfDocxConfirmMsg: 'Caricare questo PDF sul cloud ZenMux e convertirlo in Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      "Impossibile accedere a ZenMux: manca un componente necessario (gsk). Reinstallare l'app.",
  ...
  pl: {
    ...
    pdfDocxLoginMsg: 'Eksport do formatu Word wymaga zalogowania do ZenMux.',
    pdfDocxLoginDetail:
      'Kliknij „Zaloguj się”, aby autoryzować w przeglądarce; po zakończeniu kliknij Eksportuj ponownie.',
    pdfDocxBtnLogin: 'Zaloguj się',
    pdfDocxConfirmMsg: 'Przesłać ten PDF do chmury ZenMux i przekonwertować na Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Nie można zalogować się do ZenMux: brakuje wymaganego komponentu (gsk). Zainstaluj aplikację ponownie.',
  ...
  nl: {
    ...
    pdfDocxLoginMsg: 'Exporteren als Word vereist inloggen bij ZenMux.',
    pdfDocxLoginDetail:
      'Klik op “Inloggen” om in de browser te autoriseren; klik daarna opnieuw op Exporteren.',
    pdfDocxBtnLogin: 'Inloggen',
    pdfDocxConfirmMsg: 'Deze PDF uploaden naar de ZenMux-cloud en converteren naar Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Kan niet inloggen bij ZenMux: een vereist onderdeel (gsk) ontbreekt. Installeer de app opnieuw.',
  ...
  ms: {
    ...
    pdfDocxLoginMsg: 'Eksport sebagai Word memerlukan log masuk ke ZenMux.',
    pdfDocxLoginDetail:
    ...
    pdfDocxConfirmMsg: 'Muat naik PDF ini ke awan ZenMux untuk ditukar kepada Word?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'Tidak dapat log masuk ke ZenMux: komponen yang diperlukan (gsk) tiada. Sila pasang semula aplikasi.',
  ...
  he: {
    ...
    pdfDocxLoginMsg: 'ייצוא כ-Word דורש התחברות ל-ZenMux.',
    pdfDocxLoginDetail: 'לחיצה על ”התחברות” תפתח את הדפדפן לאישור; בסיום, לחצו שוב על ייצוא.',
    pdfDocxBtnLogin: 'התחברות',
    pdfDocxConfirmMsg: 'להעלות את ה-PDF לענן של ZenMux ולהמיר אותו ל-Word?',
    ...
    pdfDocxNoCliMsg: 'לא ניתן להתחבר ל-ZenMux: רכיב נדרש (gsk) חסר. נא להתקין מחדש את האפליקציה.',
  ...
  hi: {
    ...
    pdfDocxLoginMsg: 'Word के रूप में निर्यात करने के लिए ZenMux में लॉगिन आवश्यक है।',
    pdfDocxLoginDetail:
      '“लॉगिन” पर क्लिक करने से ब्राउज़र में प्राधिकरण खुलेगा; पूरा होने पर फिर से निर्यात पर क्लिक करें।',
    pdfDocxBtnLogin: 'लॉगिन',
    pdfDocxConfirmMsg: 'इस PDF को ZenMux क्लाउड पर अपलोड करके Word में बदलें?',
    pdfDocxConfirmDetail:
    ...
    pdfDocxNoCliMsg:
      'ZenMux में साइन इन नहीं किया जा सकता: आवश्यक घटक (gsk) मौजूद नहीं है। कृपया ऐप को फिर से इंस्टॉल करें।',
  ...
  'zh-TW': {
    ...
    pdfDocxLoginMsg: '匯出為 Word 需要登入 ZenMux 帳號。',
    pdfDocxLoginDetail: '點擊「登入」將開啟瀏覽器完成授權，完成後請重新點擊匯出。',
    pdfDocxBtnLogin: '登入',
    pdfDocxConfirmMsg: '將此 PDF 上傳到 ZenMux 雲端轉換為 Word？',
    ...
    pdfDocxNoCliMsg: '無法登入 ZenMux：缺少必要元件（gsk），請重新安裝應用程式。',
...
function registerHomeIpc(): void {
  // This build has no separate web account. AI authentication lives only in the locally saved
  // ZenMux API Key; legacy account channels remain as inert compatibility shims for old renderers.
...
async function installMainProcessProxy(): Promise<void> {
  ...
  if (!proxyUrl) {
    try {
      // PAC/rule proxies answer per-host: probe the ZenMux API used by AI requests.
      const resolved = await session.defaultSession.resolveProxy('https://zenmux.ai/api/v1')
