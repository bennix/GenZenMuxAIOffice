export const strings = {
  zh: {
    ...
    aiCreditsExhausted: '积分不足，请前往 zenmux.ai 充值',
  ...
  en: {
    ...
    aiCreditsExhausted: 'Out of credits — top up at zenmux.ai',
  ...
  ja: {
    ...
    aiCreditsExhausted: 'クレジット不足です。zenmux.ai でチャージしてください',
  ...
  ko: {
    ...
    aiCreditsExhausted: '크레딧이 부족합니다. zenmux.ai에서 충전하세요',
  ...
  fr: {
    ...
    aiCreditsExhausted: 'Crédits épuisés — rechargez sur zenmux.ai',
  ...
  de: {
    ...
    aiCreditsExhausted: 'Guthaben aufgebraucht — bei zenmux.ai aufladen',
  ...
  es: {
    ...
    aiCreditsExhausted: 'Sin créditos — recarga en zenmux.ai',
  ...
  th: {
    ...
    aiCreditsExhausted: 'เครดิตหมด — เติมได้ที่ zenmux.ai',
  ...
  id: {
    ...
    aiCreditsExhausted: 'Kredit habis — isi ulang di zenmux.ai',
  ...
  ru: {
    ...
    aiCreditsExhausted: 'Кредиты закончились — пополните на zenmux.ai',
  ...
  ar: {
    ...
    aiCreditsExhausted: 'نفدت الأرصدة — أعد الشحن على zenmux.ai',
  ...
  pt: {
    ...
    aiCreditsExhausted: 'Créditos esgotados — recarregue em zenmux.ai',
  ...
  it: {
    ...
    aiCreditsExhausted: 'Crediti esauriti — ricarica su zenmux.ai',
  ...
  pl: {
    ...
    aiCreditsExhausted: 'Brak kredytów — doładuj na zenmux.ai',
  ...
  nl: {
    ...
    aiCreditsExhausted: 'Credits op — waardeer op via zenmux.ai',
  ...
  ms: {
    ...
    aiCreditsExhausted: 'Kredit habis — tambah nilai di zenmux.ai',
  ...
  he: {
    ...
    aiCreditsExhausted: 'נגמרו הקרדיטים — טענו ב-zenmux.ai',
  ...
  hi: {
    ...
    aiCreditsExhausted: 'क्रेडिट समाप्त — zenmux.ai पर रिचार्ज करें',
  ...
  'zh-TW': {
    ...
    aiCreditsExhausted: '點數不足，請前往 zenmux.ai 儲值',
