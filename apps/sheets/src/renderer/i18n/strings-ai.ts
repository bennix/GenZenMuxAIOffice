...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiZenMuxAccount: 'ZenMux 账号',
    aiAccountChecking: '检测中…',
    aiLoggedIn: '已登录',
    aiLoggedInAs: '已登录：{email}',
    aiNotLoggedIn: '未登录（AI 功能需要登录 ZenMux 账号）',
    aiWaitingBrowserLogin: '等待浏览器登录…',
    aiLoginZenMux: '登录 ZenMux',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '保存',
    aiUnknownError: '未知错误',
    aiTimeoutError: 'AI 请求超时：网络长时间无响应，已停止。请检查网络后重试',
    aiCreditsExhausted: 'ZenMux 积分已用完，请前往 zenmux.ai/models 充值后重试',
  ...
  en: {
    ...
    aiGskLoginBtn: 'Sign in to ZenMux',
    ...
    aiZenMuxAccount: 'ZenMux account',
    aiAccountChecking: 'Checking…',
    aiLoggedIn: 'Signed in',
    aiLoggedInAs: 'Signed in: {email}',
    aiNotLoggedIn: 'Not signed in (AI features require a ZenMux account)',
    aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
    aiLoginZenMux: 'Sign in to ZenMux',
    aiModel: 'Model',
    aiCancel: 'Cancel',
    aiSave: 'Save',
    ...
    aiCreditsExhausted:
      'Your ZenMux credits have run out. Visit zenmux.ai/models to top up, then try again',
  ...
  ja: {
    ...
    aiZenMuxAccount: 'ZenMux アカウント',
    aiAccountChecking: '確認中…',
    aiLoggedIn: 'サインイン済み',
    aiLoggedInAs: 'サインイン済み: {email}',
    aiNotLoggedIn: '未サインイン（AI 機能には ZenMux アカウントへのサインインが必要です）',
    aiWaitingBrowserLogin: 'ブラウザーでのサインインを待機中…',
    aiLoginZenMux: 'ZenMux にサインイン',
    aiModel: 'モデル',
    aiCancel: 'キャンセル',
    aiSave: '保存',
    ...
    aiCreditsExhausted:
      'ZenMuxクレジットを使い切りました。zenmux.ai/models でチャージしてから再試行してください',
  ...
  ko: {
    ...
    aiZenMuxAccount: 'ZenMux 계정',
    aiAccountChecking: '확인 중…',
    aiLoggedIn: '로그인됨',
    aiLoggedInAs: '로그인됨: {email}',
    aiNotLoggedIn: '로그인되지 않음(AI 기능을 사용하려면 ZenMux 계정 로그인이 필요합니다)',
    aiWaitingBrowserLogin: '브라우저 로그인 대기 중…',
    aiLoginZenMux: 'ZenMux 로그인',
    aiModel: '모델',
    aiCancel: '취소',
    aiSave: '저장',
    ...
    aiCreditsExhausted:
      'ZenMux 크레딧을 모두 사용했습니다. zenmux.ai/models에서 충전한 후 다시 시도해 주세요',
  ...
  fr: {
    ...
    aiGskLoginBtn: 'Se connecter à ZenMux',
    ...
    aiZenMuxAccount: 'Compte ZenMux',
    aiAccountChecking: 'Vérification…',
    aiLoggedIn: 'Connecté',
    aiLoggedInAs: 'Connecté : {email}',
    aiNotLoggedIn: 'Non connecté (les fonctions IA nécessitent un compte ZenMux)',
    aiWaitingBrowserLogin: 'En attente de la connexion dans le navigateur…',
    aiLoginZenMux: 'Se connecter à ZenMux',
    aiModel: 'Modèle',
    aiCancel: 'Annuler',
    aiSave: 'Enregistrer',
    ...
    aiCreditsExhausted:
      'Vos crédits ZenMux sont épuisés. Rechargez sur zenmux.ai/models puis réessayez',
  ...
  de: {
    ...
    aiGskLoginBtn: 'Bei ZenMux anmelden',
    ...
    aiCreditsExhausted:
      'Deine ZenMux-Credits sind aufgebraucht. Lade unter zenmux.ai/models auf und versuche es erneut',
  ...
  es: {
    ...
    aiGskLoginBtn: 'Iniciar sesión en ZenMux',
    ...
    aiCreditsExhausted:
      'Tus créditos de ZenMux se han agotado. Recarga en zenmux.ai/models e inténtalo de nuevo',
  ...
  th: {
    ...
    aiGskLoginBtn: 'ลงชื่อเข้าใช้ ZenMux',
    ...
    aiCreditsExhausted:
      'เครดิต ZenMux ของคุณหมดแล้ว โปรดเติมเครดิตที่ zenmux.ai/models แล้วลองใหม่',
  ...
  id: {
    ...
    aiCreditsExhausted:
      'Kredit ZenMux Anda telah habis. Isi ulang di zenmux.ai/models lalu coba lagi',
  ...
  ru: {
    ...
    aiZenMuxAccount: 'Учётная запись ZenMux',
    aiAccountChecking: 'Проверка…',
    aiLoggedIn: 'Вход выполнен',
    aiLoggedInAs: 'Вход выполнен: {email}',
    aiNotLoggedIn: 'Вход не выполнен (для функций ИИ требуется учётная запись ZenMux)',
    aiWaitingBrowserLogin: 'Ожидание входа в браузере…',
    aiLoginZenMux: 'Войти в ZenMux',
    aiModel: 'Модель',
    aiCancel: 'Отмена',
    aiSave: 'Сохранить',
    ...
    aiCreditsExhausted:
      'Кредиты ZenMux исчерпаны. Пополните баланс на zenmux.ai/models и повторите попытку',
  ...
  ar: {
    ...
    aiGskLoginBtn: 'تسجيل الدخول إلى ZenMux',
    ...
    aiCreditsExhausted:
      'نفدت أرصدة ZenMux لديك. يرجى إعادة الشحن عبر zenmux.ai/models ثم المحاولة مجددًا',
  ...
  pt: {
    ...
    aiGskLoginBtn: 'Entrar no ZenMux',
    ...
    aiCreditsExhausted:
      'Seus créditos ZenMux acabaram. Recarregue em zenmux.ai/models e tente novamente',
  ...
  it: {
    ...
    aiCreditsExhausted:
      'I tuoi crediti ZenMux sono esauriti. Ricarica su zenmux.ai/models e riprova',
  ...
  pl: {
    ...
    aiGskLoginBtn: 'Zaloguj się do ZenMux',
    ...
    aiCreditsExhausted:
      'Twoje kredyty ZenMux wyczerpały się. Doładuj konto na zenmux.ai/models i spróbuj ponownie',
  ...
  nl: {
    ...
    aiGskLoginBtn: 'Aanmelden bij ZenMux',
    ...
    aiNotLoggedIn: 'Niet aangemeld (AI-functies vereisen een ZenMux-account)',
    aiWaitingBrowserLogin: 'Wachten op aanmelding in de browser…',
    aiLoginZenMux: 'Aanmelden bij ZenMux',
    aiModel: 'Model',
    aiCancel: 'Annuleren',
    aiSave: 'Opslaan',
    ...
    aiCreditsExhausted:
      'Je ZenMux-credits zijn op. Waardeer op via zenmux.ai/models en probeer het opnieuw',
  ...
  ms: {
    ...
    aiGskLoginBtn: 'Log masuk ke ZenMux',
    ...
    aiCreditsExhausted:
      'Kredit ZenMux anda telah habis. Tambah nilai di zenmux.ai/models dan cuba lagi',
  ...
  hi: {
    ...
    aiGskLoginBtn: 'ZenMux में साइन इन करें',
    ...
    aiCreditsExhausted:
      'आपके ZenMux क्रेडिट समाप्त हो गए हैं। zenmux.ai/models पर रिचार्ज करें और फिर से प्रयास करें',
  ...
  'zh-TW': {
    ...
    aiZenMuxAccount: 'ZenMux 帳號',
    aiAccountChecking: '偵測中…',
    aiLoggedIn: '已登入',
    aiLoggedInAs: '已登入：{email}',
    aiNotLoggedIn: '未登入（AI 功能需要登入 ZenMux 帳號）',
    aiWaitingBrowserLogin: '等待瀏覽器登入…',
    aiLoginZenMux: '登入 ZenMux',
    aiModel: '模型',
    aiCancel: '取消',
    aiSave: '儲存',
    aiUnknownError: '未知錯誤',
    aiTimeoutError: 'AI 請求逾時：網路長時間無回應，已停止。請檢查網路後重試',
    aiCreditsExhausted: 'ZenMux 點數已用完，請前往 zenmux.ai/models 儲值後重試',
