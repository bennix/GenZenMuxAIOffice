...
% Representative UI screenshots were captured from an earlier release; this guide is updated for v0.6.86.
...
\ifManualChineseOnly
  ...
  \newcommand{\ManualPdfSubject}{ZenOffice v0.6.86 中文用户指南}
\else\ifManualEnglishOnly
  ...
  \newcommand{\ManualPdfSubject}{ZenOffice v0.6.86 English user manual}
\else
  \newcommand{\CNText}[1]{#1}
  \newcommand{\ENText}[1]{#1}
  ...
  \newcommand{\ManualPdfSubject}{ZenOffice v0.6.86 bilingual getting-started manual}
\fi\fi
...
\fancyhead[R]{\footnotesize\color{GOMuted} v0.6.86 · 2026-09-16}
...
{\color{white!70}\small v0.6.86 · 2026-09-16 · macOS / Windows / Ubuntu / RPM\par}
\clearpage
...
\vfill
{\color{white}\bfseries ZenOffice v0.6.86 · ZenMux AI\par}
