...
[最新 Release 下载签名并经 Apple 公证的 DMG](https://github.com/bennix/GenZenMuxAIOffice/releases/latest/download/GenOffice-0.6.36-arm64.dmg)。
Windows 10/11 x64 用户可下载
[GenOfficeSetup-0.6.36-x64.exe](https://github.com/bennix/GenZenMuxAIOffice/releases/latest/download/GenOfficeSetup-0.6.36-x64.exe)；当前 Windows 安装包未做 Authenticode 签名，SmartScreen 可能显示“未知发布者”。
...
- **Presentation recording and MP4 playback** — start recording directly from the Slide Show or Insert ribbon, capture the full-screen show with microphone narration and available system/presentation audio, pause or resume, and export a local H.264/AAC MP4; insert MP4/M4V/MOV/WebM media and play it in editing preview or slide show.
...
| ------------------------------------ | ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [GenOffice-0.6.36-arm64.dmg](https://github.com/bennix/GenZenMuxAIOffice/releases/latest/download/GenOffice-0.6.36-arm64.dmg)       |
...
| **Windows** (x64)                    | Windows 10/11; unsigned, SmartScreen may warn         | [GenOfficeSetup-0.6.36-x64.exe](https://github.com/bennix/GenZenMuxAIOffice/releases/latest/download/GenOfficeSetup-0.6.36-x64.exe) |
